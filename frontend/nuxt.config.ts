...
export default defineNuxtConfig({
  app: {
    head: {
      ...
      link: [
        { rel: 'icon', type: 'image/png', href: 'abr-avaran-logo.png' },
        ...
        { rel: 'apple-touch-icon', href: '/assets/photos/abr-avaran-logo.png' },
      ...
      meta: [
        ...
        { property: 'og:image', content: 'https://avarancloud.ir/assets/photos/abr-avaran-logo.png' },
        ...
        { name: 'twitter:image', content: 'https://avarancloud.ir/assets/photos/abr-avaran-logo.png' },
      ...
      script: [
        ...
        },
        {
          innerHTML: `{
            ...
            "logo": "https://avarancloud.ir/assets/photos/abr-avaran-logo.png",
        ...
        },
        {
          innerHTML: `{
            ...
            "image": "https://avarancloud.ir/assets/photos/abr-avaran-logo.png",
            "description": "ابرآوران ارائه دهنده خدمات طراحی سایت و سایت ساز حرفه‌ای با امکانات کامل مدیریتی"
          }`,
          type: 'application/ld+json'
        },
