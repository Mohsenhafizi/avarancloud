...
<div class="relative z-10 top-20 top-20 mb-24">
    ...
    <div class="flex justify-center lg:mr-10">
        <div class="mx-2 md:mx-60 grid grid-cols-12 gap-0 md:gap-x-16 gap-y-6 my-5">
            ...
            <div class="col-span-12 sm:col-span-6 md:col-span-4 hover:border-1 hover:border-gray-400 rounded-2xl transition-all" data-aos="fade-right" data-aos-delay="600">
                <div class="relative lg:p-3">
...
.col-span-12:hover::before {
  border-color: #3d3393;
  box-shadow: 0 0 15px rgba(61, 51, 147, 0.2);
  transform: scale(1);
  opacity: 1;
}
