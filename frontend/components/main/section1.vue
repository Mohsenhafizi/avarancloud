<template>
<div class="md:mx-20 pb-10 mt-5 md:mt-30 flex items-center justify-center min-h-screen bg-blue-50 rounded-3xl">
    <div class="text-center p-8">
        ...
        <div class="mx-15 md:mx-40">
          ...
          <div
            class="absolute invisible opacity-0 group-hover:visible group-hover:opacity-100 bottom-full left-45 -translate-x-1/2 mb-3 w-30 transition-all duration-300 ease-out transform group-hover:translate-y-0 translate-y-2"
          >
          <div class="rounded-br-3xl rounded-t-3xl bg-stone-200 p-2">
          اتصال دامنه
          </div>
          </div>
        </div>
        ...
        <div class="relative inline-block group z-0">
          ...
          >
          <div class="rounded-br-3xl rounded-t-3xl bg-stone-300 px-2 py-3">
            نمونه کار 
          </div>
