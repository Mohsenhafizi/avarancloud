      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mx-10 xl:mx-0 gap-6 lg:gap-28 px-4 py-10 lg:pt-20">
        <div class="">
            ...
            <ul class="text-gray-500 dark:text-gray-400 lg:w-70">
                <li class="mb-10">
                    دیجی‌فای پلتفرمی یکپارچه برای ساختن وب‌سایته. با استفاده از دیجی‌فای همه می‌تونن با هر سطحی از دانش فنی، برای کسب‌وکارشون یه سایت بسازن و فقط با استفاده از پنل دیجی‌فای، سفارشات خودشون رو از مرحله‌ی پرداخت تا ارسال و وفادارسازی مشتری مدیریت کنن. به‌علاوه، با استفاده از بسته‌های مکمل دیجی‌فای، هر کسب‌وکاری می‌تونه ترافیک سایتش رو افزایش بده و یه ظاهر زیبا و چشم‌گیر برای سایتش ایجاد کنه.
                </li>
            </ul>
        </div>
        <div>
            ...
            <li class="mb-10">
                <a href="#" class="flex gap-1">
                    ...
                    <span class="pt-1.5 text-sm">
                        Mohsenhafizi90@gmail.com
                    </span>
                </a>
            </li>
            <li class="flex mb-16">
