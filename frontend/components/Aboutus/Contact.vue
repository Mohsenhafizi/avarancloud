...
const headingMap: Record<string, string> = {
  bronz: "برای دریافت پکیج برنزی",
  sefareshi: "برای دریافت پکیج سفارشی",
  nogrei: "برای دریافت پکیج نقره ای",
  talai: "برای دریافت پکیج طلایی",
  abrkochaak: "برای دریافت پکیج ابر کوچک",
  abrafzar: "برای دریافت پکیج نرم افزار ابری",
  hoshabr: "برای دریافت پکیج ابر هوش",
  revan: "برای دریافت پکیج ابر روان",
  barvar: "برای دریافت پکیج ابر بارور",
  tekeabr: "برای دریافت پکیج تکه ابر",
  abrsefareshi: "برای دریافت پکیج ابر سفارشی",
};
